...
### 3.3 경상남도 김해시 — 5대 강력범죄 예방 및 검거율 상승

- **도입 장소:** 경상남도 김해시 전역  
- **시스템 명칭:** 지능형 관제시스템 **‘스마트 선별관제’**

- **적용 기술 (How)**  
  * **특이 패턴 선별 표출:** AI가 사람·차량의 움직임이 없는 **평소와 다른 패턴**(배회, 침입, 쓰러짐 등)만 **관제 화면에 자동 표출**  
  * **심야 집중 감시:** 관제 요원이 놓치기 쉬운 **심야 시간대 범죄 징후**를 우선 포착  
  * **오탐 억제:** 정상 흐름은 숨기고 **이상 패턴만 표출**하여 관제 집중도 향상  

- **실제 효과 및 사례**  
  * **강력범죄 검거율 3배↑**  
    - 시스템 도입 후 **살인·강도 등 5대 강력범죄 현행범 검거율**이 이전 대비 **3배 이상 증가** (김해시 공식 발표)  
  * **차량털이범 현행범 검거 (2022.11)**  
    - 새벽, 주차 차량 주변을 **서성이는 남성**을 AI가 ‘배회’ 패턴으로 감지  
    - 관제 요원 주시 → 남성이 **차 문을 여는 행위** 확인 즉시 경찰 신고  
    - 경찰 출동 후 **현행범 검거**  

---
### 3.4 경기도 오산시 — 지능형 CCTV 위험징후 자동 인식
